...
var app = (function () {
    ...
    var bpmnNavigatedViewer_development = createCommonjsModule(function (module, exports) {
    /*!
     * bpmn-js - bpmn-navigated-viewer v5.0.0-beta.4
     *
    ...
    /* src\components\Diagram.svelte generated by Svelte v3.8.0 */
    const { console: console_1 } = globals;

    const file = "src\\components\\Diagram.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			attr(div, "class", "svelte-9wpbe6");
    			add_location(div, file, 45, 0, 756);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
      ...
      let { xml, onImportDone } = $$props;

      let container, viewer;

      onMount(() => {
        viewer = new bpmnNavigatedViewer_development({
          container
        });
      });
      ...
      afterUpdate(() => {
    	...
    	const writable_props = ['xml', 'onImportDone'];
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console_1.warn(`<Diagram> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$set = $$props => {
    		if ('xml' in $$props) $$invalidate('xml', xml = $$props.xml);
    		if ('onImportDone' in $$props) $$invalidate('onImportDone', onImportDone = $$props.onImportDone);
    	};
    ...
    class Diagram extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, not_equal, ["xml", "onImportDone"]);

    		const { ctx } = this.$$;
    		const props = options.props || {};
    		if (ctx.xml === undefined && !('xml' in props)) {
    			console_1.warn("<Diagram> was created without expected prop 'xml'");
    		}
    		if (ctx.onImportDone === undefined && !('onImportDone' in props)) {
    			console_1.warn("<Diagram> was created without expected prop 'onImportDone'");
    		}
    	}
    ...
    /* src\components\FileDrop.svelte generated by Svelte v3.8.0 */

    const file$1 = "src\\components\\FileDrop.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(div, "class", "file-drop svelte-1varfwk");
    			add_location(div, file$1, 48, 0, 872);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
      ...
      onMount(() => {
    	...
    	const writable_props = ['onFileDrop'];
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn(`<FileDrop> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$set = $$props => {
    		if ('onFileDrop' in $$props) $$invalidate('onFileDrop', onFileDrop = $$props.onFileDrop);
    ...
    class FileDrop extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, not_equal, ["onFileDrop"]);

    		const { ctx } = this.$$;
    		const props = options.props || {};
    		if (ctx.onFileDrop === undefined && !('onFileDrop' in props)) {
    			console.warn("<FileDrop> was created without expected prop 'onFileDrop'");
    		}
    	}

    	get onFileDrop() {
    		throw new Error("<FileDrop>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set onFileDrop(value) {
    		throw new Error("<FileDrop>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src\components\Loader.svelte generated by Svelte v3.8.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			img = element("img");
    			attr(img, "src", "animated-logo-grey-48.gif");
    			add_location(img, file$2, 25, 2, 434);
    			attr(div, "class", "" + null_to_empty(ctx.classNames) + " svelte-1d6vo0f");
    			add_location(div, file$2, 24, 0, 404);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn(`<Loader> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$.update = ($$dirty = { visible: 1 }) => {
    		if ($$dirty.visible) { $$invalidate('classNames', classNames = visible ? 'loader visible' : 'loader'); }
    	};

    	return { visible, classNames };
    }

    class Loader extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, not_equal, ["visible"]);
    ...
    /* src\Inspector.svelte generated by Svelte v3.8.0 */

    const file$3 = "src\\Inspector.svelte";

    // (66:0) <FileDrop onFileDrop={ putDiagram }>
    function create_default_slot(ctx) {
    	...
    	return {
    		...
    		p: function update(changed, ctx) {
    			var diagram_changes = {};
    			if (changed.xml) diagram_changes.xml = ctx.xml;
    			if (changed.loaderVisible) diagram_changes.onImportDone = ctx.func;
    ...
    function create_fragment$3(ctx) {
    	var t0, t1, div, t2, current;

    	var loader = new Loader({
    		props: { visible: ctx.loaderVisible },
    		$$inline: true
    	});

    	var filedrop = new FileDrop({
    		props: {
    		onFileDrop: ctx.putDiagram,
    	...
    	return {
    		c: function create() {
    			...
    			div = element("div");
    			t2 = text(ctx.name);
    			attr(div, "class", "diagram-name svelte-10qeicd");
    			add_location(div, file$3, 69, 0, 1360);
    		},
    		...
    		p: function update(changed, ctx) {
    			var loader_changes = {};
    			if (changed.loaderVisible) loader_changes.visible = ctx.loaderVisible;
    			loader.$set(loader_changes);

    			var filedrop_changes = {};
    			if (changed.putDiagram) filedrop_changes.onFileDrop = ctx.putDiagram;
    			if (changed.$$scope || changed.xml || changed.loaderVisible) filedrop_changes.$$scope = { changed, ctx };
    ...
    function instance$3($$self, $$props, $$invalidate) {
      ...
      const putDiagram = async diagram => {
        ...
        $$invalidate('loaderVisible', loaderVisible = true);
      ...
      const setDiagram = ({ contents, path }) => {
        if (contents) {
          $$invalidate('xml', xml = contents);
          $$invalidate('name', name = path);
        }  };

      getDiagram('/api/diagram');

    	function func() {
    		const $$result = loaderVisible = false;
    		$$invalidate('loaderVisible', loaderVisible);
    		return $$result;
    	}
