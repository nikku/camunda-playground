...
var app = (function () {
    ...
    var bpmnViewer_development = createCommonjsModule(function (module, exports) {
    /*!
     * bpmn-js - bpmn-viewer v5.0.0-beta.4
     *
    ...
    const file = "src\\Inspector.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file, 26, 0, 590);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
      ...
      onMount(() => {
        const viewer = new bpmnViewer_development({
          container
        });
